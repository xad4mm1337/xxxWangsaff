...
//=================================================//
    ...
    xie.sendMessage(from, { react: { text: `${global.reactmoji}`, key: m.key }})
      let regex = /x/g
      ...
      for (let i = 0; i < total; i++) {
          ...
          if (await xie.onWhatsApp(result).then(v => (v[0] || {}).exists)) {
              let info = await xie.fetchStatus(result).catch(_ => {})
